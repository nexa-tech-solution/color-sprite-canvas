...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A cozy, infinite-canvas painting app. Draw, import photos, and turn any image into a coloring page you can paint right in your browser." },
      { name: "author", content: "PastelPaint" },
      { property: "og:title", content: "PastelPaint — Cute infinite canvas painting" },
      { property: "og:description", content: "Draw, import photos, and turn any image into a coloring page — right in your browser." },
